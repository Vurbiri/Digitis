...
public class ButtonPressHotkey : ButtonPress, IButtonInteractable, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler, IPointerUpHandler
{
    [Space]
    ...
    private bool _isPressedHotkey = false;
    ...
    private void Update()
    {
        ...
        {
            OnPointerDown(null);
            _isPressedHotkey = true;
        }
        else if (_isPressedHotkey)
        {
            OnPointerUp(null);
            _isPressedHotkey = false;
        }
    }
}
